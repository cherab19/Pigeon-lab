...
import { IndicatorsLab, PHMeterSim, WeakAcidIonization, BufferSolutions, AcidBaseTitration, ElectrolysisMetal, VoltaicCell, HaberProcess, AdditionPolymerization, AirPollutionAcidRain } from "./chemistry/Grade12Chemistry";
...
export const simulationRegistry: Record<string, ComponentType> = {
  ...
  "c12-1": IndicatorsLab, "c12-2": PHMeterSim, "c12-3": WeakAcidIonization, "c12-4": BufferSolutions, "c12-5": AcidBaseTitration,
