...
export const labData: Record<string, Record<number, LabActivity[]>> = {
  ...
  chemistry: {
    ...
    10: [
      ...
      { id: "c10-1", unit: 1, unitName: "Reactions & Stoichiometry", title: "Combination Reaction (Fe + S)", objective: "Observe a combination reaction forming iron sulfide", theory: "In a combination reaction, two or more substances combine to form a single product. Fe + S → FeS is an exothermic reaction." },
      { id: "c10-2", unit: 1, unitName: "Reactions & Stoichiometry", title: "Decomposition of CuCO₃", objective: "Observe thermal decomposition of copper carbonate", theory: "CuCO₃ → CuO + CO₂. Green copper carbonate decomposes when heated to black copper oxide, releasing carbon dioxide gas." },
      { id: "c10-3", unit: 1, unitName: "Reactions & Stoichiometry", title: "Single Displacement (Fe + CuSO₄)", objective: "Demonstrate displacement reaction between iron and copper sulfate", theory: "Fe + CuSO₄ → FeSO₄ + Cu. A more reactive metal displaces a less reactive one from solution." },
      { id: "c10-4", unit: 1, unitName: "Reactions & Stoichiometry", title: "Double Displacement Reaction", objective: "Observe formation of a precipitate in double displacement", theory: "When two ionic compounds in solution exchange ions, an insoluble precipitate may form." },
      // UNIT 2: Solutions
      { id: "c10-5", unit: 2, unitName: "Solutions", title: "Standard Solution Preparation", objective: "Prepare a solution of known concentration", theory: "A standard solution has a precisely known concentration. Concentration = moles of solute / volume in litres." },
      { id: "c10-6", unit: 2, unitName: "Solutions", title: "Dilution of a Solution", objective: "Prepare a dilute solution from a concentrated one using M₁V₁ = M₂V₂", theory: "M₁V₁ = M₂V₂. When you dilute, the amount of solute stays constant but concentration decreases." },
      { id: "c10-7", unit: 2, unitName: "Solutions", title: "Solubility vs Temperature", objective: "Observe how temperature affects solubility", theory: "Solubility of most solids increases with temperature. A saturated solution contains maximum dissolved solute at a given temperature." },
      // UNIT 3: Acids, Bases & Salts
      { id: "c10-8", unit: 3, unitName: "Acids, Bases & Salts", title: "pH & Indicators", objective: "Determine acidity or alkalinity using indicators and pH meter", theory: "pH measures hydrogen ion concentration on a 0-14 scale. Acids < 7, Neutral = 7, Bases > 7." },
      { id: "c10-9", unit: 3, unitName: "Acids, Bases & Salts", title: "Acid + Metal → H₂ Gas", objective: "Observe hydrogen gas production from metal-acid reaction", theory: "Reactive metals displace hydrogen from acids: Metal + HCl → Metal Chloride + H₂." },
      { id: "c10-10", unit: 3, unitName: "Acids, Bases & Salts", title: "Acid-Base Titration", objective: "Determine concentration of an acid by neutralization", theory: "At equivalence point, moles acid = moles base. Phenolphthalein turns pink above pH 8.2." },
      // UNIT 4: Energy & Electrochemistry
      { id: "c10-11", unit: 4, unitName: "Energy & Electrochemistry", title: "Exothermic vs Endothermic", objective: "Compare reactions that release vs absorb heat", theory: "Exothermic: ΔH < 0, temperature rises. Endothermic: ΔH > 0, temperature drops." },
      { id: "c10-12", unit: 4, unitName: "Energy & Electrochemistry", title: "Electrochemical Cell (Zn-Cu)", objective: "Build a galvanic cell and measure voltage", theory: "Zn is oxidized at the anode, Cu²⁺ is reduced at the cathode. E°cell = 1.10V." },
      { id: "c10-13", unit: 4, unitName: "Energy & Electrochemistry", title: "Electrolysis of Water", objective: "Decompose water into hydrogen and oxygen using electricity", theory: "2H₂O → 2H₂ + O₂. H₂ at cathode (2× volume), O₂ at anode." },
      // UNIT 5: Metals & Nonmetals
      { id: "c10-14", unit: 5, unitName: "Metals & Nonmetals", title: "Metal Reactivity Series", objective: "Compare reactivity of metals with acid", theory: "Reactivity: Mg > Zn > Fe > Cu. More reactive metals produce H₂ faster." },
      { id: "c10-15", unit: 5, unitName: "Metals & Nonmetals", title: "Metal Extraction (Reduction)", objective: "Observe reduction of metal oxide using carbon", theory: "2Fe₂O₃ + 3C → 4Fe + 3CO₂. Carbon reduces moderately reactive metal oxides at high temperatures." },
      // UNIT 6: Hydrocarbons
      { id: "c10-16", unit: 6, unitName: "Hydrocarbons", title: "Hydrocarbon Combustion", objective: "Compare complete vs incomplete combustion", theory: "Complete: CH₄ + 2O₂ → CO₂ + 2H₂O (blue flame). Incomplete: yellow flame, soot, CO produced." },
      { id: "c10-17", unit: 6, unitName: "Hydrocarbons", title: "Bromine Test for Unsaturation", objective: "Test for C=C double bonds using bromine water", theory: "Alkenes decolorize bromine water (addition reaction). Alkanes do not react." },
    ],
    11: [
      // UNIT 1: Atomic Structure & Periodic Properties
      { id: "c11-1", unit: 1, unitName: "Atomic Structure", title: "Cathode Ray Tube Experiment", objective: "Discover the electron through beam deflection in a CRT", theory: "J.J. Thomson used electric and magnetic fields to deflect cathode rays, proving they are negatively charged particles (electrons) with a measurable e/m ratio." },
      { id: "c11-2", unit: 1, unitName: "Atomic Structure", title: "Rutherford Gold Foil Experiment", objective: "Simulate alpha particle scattering to discover the nuclear model", theory: "Rutherford fired alpha particles at thin gold foil. Most passed through, some deflected, very few bounced back—proving a small, dense, positive nucleus." },
      { id: "c11-3", unit: 1, unitName: "Atomic Structure", title: "Photoelectric Effect", objective: "Investigate how light frequency affects electron emission", theory: "Electrons are emitted when light frequency exceeds the threshold: KE = hf − φ. KE depends on frequency, not intensity." },
      // UNIT 2: Chemical Bonding
      { id: "c11-4", unit: 2, unitName: "Chemical Bonding", title: "Ionic Bond Formation", objective: "Observe electron transfer and ionic crystal formation", theory: "Ionic bonds form when electrons transfer from metal to non-metal atoms. The resulting ions attract via electrostatic force, forming a crystal lattice." },
      { id: "c11-5", unit: 2, unitName: "Chemical Bonding", title: "VSEPR Molecular Geometry", objective: "Predict molecular shapes from electron pair repulsion", theory: "VSEPR: electron pairs around a central atom arrange to minimize repulsion. Lone pairs occupy more space than bonding pairs." },
      { id: "c11-6", unit: 2, unitName: "Chemical Bonding", title: "Metallic Bonding (Electron Sea)", objective: "Visualize delocalized electrons in a metallic lattice", theory: "Metal atoms lose outer electrons to form a 'sea' of delocalized electrons enabling electrical and thermal conductivity." },
      // UNIT 3: Physical States of Matter
      { id: "c11-7", unit: 3, unitName: "States of Matter", title: "Kinetic Molecular Theory", objective: "Observe particle motion in solid, liquid, and gas states", theory: "Particles in solids vibrate in place, in liquids they slide past each other, and in gases they move freely and rapidly." },
      { id: "c11-8", unit: 3, unitName: "States of Matter", title: "Boyle's Law (PV = k)", objective: "Verify that pressure is inversely proportional to volume", theory: "Boyle's Law: PV = constant at constant temperature. Halving volume doubles pressure." },
      { id: "c11-9", unit: 3, unitName: "States of Matter", title: "Heating Curve of Water", objective: "Observe temperature plateaus during phase changes", theory: "During melting/boiling, temperature remains constant as energy breaks intermolecular bonds rather than increasing kinetic energy." },
      // UNIT 4: Chemical Kinetics
      { id: "c11-10", unit: 4, unitName: "Chemical Kinetics", title: "Reaction Rate Experiment", objective: "Study how concentration and temperature affect reaction rate", theory: "Increasing concentration increases collision frequency. Increasing temperature increases particle energy and collision rate." },
      { id: "c11-11", unit: 4, unitName: "Chemical Kinetics", title: "Catalyst & Activation Energy", objective: "Compare reaction rates with and without a catalyst", theory: "Catalysts lower activation energy by providing an alternative pathway, increasing the fraction of molecules with sufficient energy to react." },
      // UNIT 5: Chemical Equilibrium
      { id: "c11-12", unit: 5, unitName: "Chemical Equilibrium", title: "Reversible Reaction Simulation", objective: "Observe dynamic equilibrium in a reversible reaction", theory: "In a reversible reaction, both forward and reverse reactions occur. At equilibrium, rates are equal and concentrations are constant." },
      { id: "c11-13", unit: 5, unitName: "Chemical Equilibrium", title: "Le Chatelier's Principle", objective: "Observe equilibrium shifts when conditions change", theory: "A system at equilibrium shifts to counteract any imposed change in concentration, temperature, or pressure." },
      // UNIT 6: Organic Chemistry
      { id: "c11-14", unit: 6, unitName: "Organic Chemistry", title: "Esterification Reaction", objective: "Form an ester from a carboxylic acid and an alcohol", theory: "Esterification: Acid + Alcohol → Ester + Water. Acid catalyst (H₂SO₄) speeds up this condensation reaction." },
